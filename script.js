document.addEventListener('DOMContentLoaded', () => {
    ...
    productForm.addEventListener('submit', (e) => {
        ...
        const productIdToEdit = document.getElementById('product-id').value;
        if (productIdToEdit) {
        ...
        const newProduct = {
            ...
            image: document.getElementById('product-image').files[0] ? URL.createObjectURL(document.getElementById('product-image').files[0]) : null,
            video: document.getElementById('product-video').files[0] ? URL.createObjectURL(document.getElementById('product-video').files[0]) : null,
            audio: document.getElementById('product-audio').files[0] ? URL.createObjectURL(document.getElementById('product-audio').files[0]) : null,
            pdf: document.getElementById('product-pdf').files[0] ? URL.createObjectURL(document.getElementById('product-pdf').files[0]) : null,
            category: category,
            status: 'pending'
        };
