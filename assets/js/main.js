// Helper function to read a file and convert it to a Base64 Data URL
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const products = [
    {
      ...
      price: 500,
      shippingCost: 30,
      image: "https://via.placeholder.com/300x200/28a745/FFFFFF?text=Product+1",
      description: "صوت عالي الجودة وتصميم مريح للارتداء اليومي.",
    ...
    },
    {
      ...
      price: 1200,
      shippingCost: 30,
      image: "https://via.placeholder.com/300x200/007bff/FFFFFF?text=Product+2",
      description: "تتبع نشاطك البدني، نبضات القلب، والإشعارات.",
      category: "electronics",
      ratings: [],
      comments: [],
    },
    {
      ...
      price: 300,
      shippingCost: 15,
      image: "https://via.placeholder.com/300x200/ffc107/FFFFFF?text=Product+3",
      description: "شاحن محمول بسعة كبيرة وشحن سريع لأجهزتك.",
      category: "electronics",
      ratings: [],
      comments: [],
    },
    {
      ...
      price: 750,
      shippingCost: 50,
      image: "https://via.placeholder.com/300x200/17a2b8/FFFFFF?text=Product+4",
      description: "مثالية للمكالمات المرئية وبث الفيديوهات بجودة 1080p.",
      category: "electronics",
      ratings: [],
      comments: [],
    },
    {
      ...
      price: 950,
      shippingCost: 40,
      image: "https://via.placeholder.com/300x200/808080/FFFFFF?text=Product+5",
      description: "طقم طهي عالي الجودة لجميع أنواع المواقد.",
      category: "home",
      ratings: [],
      comments: [],
    },
    {
      ...
      price: 65,
      shippingCost: 20,
      image: "https://via.placeholder.com/300x200/556B2F/FFFFFF?text=Product+6",
      description: "رواية شهيرة للمؤلف باولو كويلو.",
      category: "books",
      ratings: [],
      comments: [],
    },
    {
      ...
      price: 200,
      shippingCost: 25,
      image: "https://via.placeholder.com/300x200/000000/FFFFFF?text=Product+7",
      description: "قميص أنيق ومريح مصنوع من القطن الناعم.",
      category: "fashion",
      ratings: [],
      comments: [],
    },
    {
      ...
      price: 450,
      shippingCost: 35,
      image: "https://via.placeholder.com/300x200/8B0000/FFFFFF?text=Product+8",
      description: "حذاء خفيف ومناسب للجري والتمارين الرياضية.",
      category: "sports",
      ratings: [],
      comments: [],
    },
    {
      ...
      price: 850,
      shippingCost: 30,
      image: "https://via.placeholder.com/300x200/FFC0CB/000000?text=Product+9",
      description: "مجموعة شاملة لجميع احتياجات المكياج.",
      category: "beauty",
      ratings: [],
      comments: [],
    },
    {
      ...
      shippingCost: 40,
      image:
        "https://via.placeholder.com/300x200/FFFF00/000000?text=Product+10",
      description: "سيارة سباق تعمل بالتحكم عن بعد، ممتعة للأطفال.",
      category: "toys",
      ratings: [],
      comments: [],
    },
    {
      ...
      shippingCost: 25,
      image:
        "https://via.placeholder.com/300x200/A0522D/FFFFFF?text=Product+11",
      description: "مجموعة تحتوي على أنواع مختارة من حبوب القهوة.",
      category: "food",
      ratings: [],
      comments: [],
    },
    {
      id: 12,
      name: "منظف داخلي للسيارة",
      price: 90,
      shippingCost: 15,
      image:
        "https://via.placeholder.com/300x200/4682B4/FFFFFF?text=Product+12",
      description: "منظف فعال لتنظيف مقاعد وأسطح السيارة.",
      category: "automotive",
      ratings: [],
      comments: [],
    },
  ...
  const getMasterProductList = () => {
    const allUserProducts = userCredentials.flatMap((user) =>
      getUserProducts(user.email)
    );
    return [
      ...products,
      ...allUserProducts.filter((p) => p.status === "accepted"),
    ];
  };
  ...
  const dashboardProductList = document.getElementById(
  ...
  if (dashboardSearchInput) {
    dashboardSearchInput.addEventListener("input", () => {
      const activeCategory =
        document.querySelector("#dashboard-page .category-list a.active")
  ...
  function initializeMetrics() {
    // 1. Seller Count
    const sellerCount = userCredentials.filter(
    ...
    if (topVisitorCount)
      topVisitorCount.textContent = (
        baseVisitorCount + visitorCount
  ...
  const searchAndRenderProducts = () => {
    ...
    const activeCategoryLink = document.querySelector(
      "#store-page .category-list a.active"
    );
    const category = activeCategoryLink
  ...
  const renderStoreProducts = (category = "all", searchTerm = "") => {
    ...
    if (sortedProducts.length === 0) {
      productList.innerHTML =
        '<p style="text-align: center; color: #888; grid-column: 1 / -1;">لا توجد منتجات مطابقة لعملية البحث.</p>';
      return;
    }
    ...
    sortedProducts.forEach((product) => {
      ...
      const imageUrl =
        product.image ||
        `https://via.placeholder.com/300x200/999/FFFFFF?text=${product.name}`;

      // Get rating metrics for display
      const metrics = getProductMetrics(product.id);
      const displayRating = metrics.averageRating.toFixed(1);
      const isFiveStar =
        metrics.averageRating >= 4.95 && metrics.commentCount > 0;
      const ratingStars =
      ...
      productCard.innerHTML = `
                ...
                <div class="product-info">
                    ...
                    ${
                      product.storeName
                        ? `<p class="store-name-display">${product.storeName}</p>`
                        : ""
                    }
  ...
  const renderDashboardProducts = (category = "all", searchTerm = "") => {
    ...
    if (filteredProducts.length === 0) {
      dashboardProductList.innerHTML =
        '<p style="text-align: center; color: #888;">لا توجد منتجات مطابقة لعملية البحث أو في هذا القسم.</p>';
      return;
    }
...
`;
      ...
      productCard.addEventListener("click", () => {
        ...
        document
          .querySelectorAll("#dashboard-page .category-list a")
          .forEach((link) => link.classList.remove("active"));
        const categoryLink = document.querySelector(
          `#dashboard-page .category-list a[data-category="${product.category}"]`
        );
  ...
  const displayProductDetails = (product) => {
    ...
    const averageRating =
      comments.length > 0 ? (totalRating / comments.length).toFixed(1) : "جديد";
    const ratingStars =
      "★".repeat(Math.round(averageRating)) +
      "☆".repeat(5 - Math.round(averageRating));

    // --- START: NEW LOGIC FOR DIGITAL CONTENT ---
    let digitalContentHTML = "";
    // Check if the product has any digital files
    if (product.video || product.pdf || product.audio) {
      digitalContentHTML = `
            <div class="digital-content-notice">
                <h4>🔒 محتوى رقمي خاص</h4>
                <p>هذا المنتج يحتوي على ملفات ستكون متاحة للعرض والتحميل من صفحة "مشترياتي" فور إتمام عملية الشراء.</p>
            </div>
        `;
    }
    // --- END: NEW LOGIC FOR DIGITAL CONTENT ---

    // --- FINAL, ORGANIZED HTML STRUCTURE ---
      ...
      product.name
            ...
            <div class="product-details">
                ...
                <div class="rating-display">
                    ...
                    <span class="rating-average">(${averageRating} / 5) - ${
      comments.length
    } تقييم</span>
                </div>
                ...
                ${digitalContentHTML} {/* This will display the notice if digital content exists */}
        ...
        <div class="details-card">
            ...
            <div class="detail-item">
                ...
                <span class="detail-value">${product.shippingCost} جنيه</span>
            </div>
            <div class="detail-item">
                <span class="detail-label">🏬 اسم المتجر:</span>
                <span class="detail-value">${product.storeName}</span>
            </div>
            <div class="detail-item">
                <span class="detail-label">🗓️ تاريخ النزول:</span>
                <span class="detail-value">${formatDateFromId(
                  product.id
                )}</span>
            </div>
        </div>
  ...
  const renderComments = (productId) => {
    ...
    comments.forEach((comment) => {
      ...
      commentCard.innerHTML = `
                <p class="comment-rating">التقييم: ${"★".repeat(
                  comment.rating
                )}</p>
  ...
  const updateCart = () => {
      ...
      cartItem.innerHTML = `
                <div class="item-info">
                    ...
                    <div class="item-quantity">
                        ...
                        <button class="add-more-btn" data-id="${
                          item.id
                        }">+</button>
                    </div>
                </div>
    ...
    cartSummary.innerHTML = `
            <p><strong>المجموع الفرعي للمنتجات:</strong> <span>${subtotal.toFixed(
              2
            )} جنيه</span></p>
            <p><strong>تكلفة الشحن:</strong> <span>${totalShipping.toFixed(
              2
            )} جنيه</span></p>
            ...
            <p><strong>الإجمالي النهائي المطلوب دفعه:</strong> <span>${grandTotal.toFixed(
              2
            )} جنيه</span></p>
        `;
    ...
    if (cart.length === 0) {
      cartItemsContainer.innerHTML =
        '<p style="text-align: center; color: #888;">سلة المشتريات فارغة.</p>';
  ...
  document.addEventListener("click", (e) => {
    ...
    if (
      e.target.id === "close-product-modal-btn" ||
      e.target === addProductModal
    ) {
    ...
    if (e.target.classList.contains("add-to-cart-btn")) {
      ...
      if (!productToAdd) {
        ...
        productToAdd = allUserProducts.find(
    ...
    const storeCategoryLinks = document.querySelectorAll(
      "#store-page .category-list a"
    );
    const dashboardCategoryLinks = document.querySelectorAll(
      "#dashboard-page .category-list a"
    );
    ...
    dashboardCategoryLinks.forEach((link) => {
      link.addEventListener("click", (e) => {
        ...
        dashboardCategoryLinks.forEach((item) =>
    ...
    // Handle Payment Buttons
// --- أضف هذا الكود داخل document.addEventListener('click', ...) ---
...
if (e.target.closest('.payment-btn')) {
    ...
    if (method) {
        const currentUserEmail = getLoggedInUserEmail();
        if (!currentUserEmail) {
            alert("خطأ: يجب تسجيل الدخول لإتمام الشراء.");
            paymentModal.style.display = 'none';
            authModal.style.display = 'flex';
            return;
        }

        // Recalculate the total directly from the cart data
        const subtotal = cart.reduce((sum, item) => sum + (parseFloat(item.price || 0) * item.quantity), 0);
        const shippingCost = 55.00; // Assuming fixed shipping
        ...
        // Get existing orders, add the new one, and save back
        const allOrders = JSON.parse(localStorage.getItem('orders')) || [];
        allOrders.push(newOrder);
        localStorage.setItem('orders', JSON.stringify(allOrders));
        
        alert(`شكرًا لك! تم تأكيد طلبك بنجاح.`);
  ...
  emailSignupForm.addEventListener("submit", (e) => {
    ...
    const paymentAccount = document
      .getElementById("payment-account-input")
      .value.trim();
  ...
  if (productForm) {
    productForm.addEventListener("submit", async (e) => {
      ...
      if (
        (imageFile && imageFile.size > maxSizeInBytes) ||
        (videoFile && videoFile.size > maxSizeInBytes) ||
        (pdfFile && pdfFile.size > maxSizeInBytes)
      ) {
        alert(
          "حجم أحد الملفات كبير جدًا! الرجاء اختيار ملفات أصغر من 2 ميجابايت."
        );
        return;
      }

      // --- 2. SUBMISSION LOGIC (ADD/EDIT) ---
      const productId = document.getElementById("product-id").value;
      const currentUserEmail = getLoggedInUserEmail();
      const userProducts = getUserProducts(currentUserEmail);
      const category =
        document.querySelector("#dashboard-page .category-list a.active")
          ?.dataset.category || "all";
      ...
      if (productId) {
        ...
        if (productIndex > -1) {
          ...
          userProducts[productIndex] = {
            ...
            pdf: pdfFile
              ? await readFileAsDataURL(pdfFile)
              : existingProduct.pdf,
            category: category,
            status: "pending",
          };
      ...
      saveUserProducts(currentUserEmail, userProducts);
      addProductModal.style.display = "none"; // Close the modal
      renderDashboardProducts(category, dashboardSearchInput.value); // Refresh the product list
    });
  }
  ...
  if (editBtn) {
    editBtn.addEventListener("click", () => {
      ...
      const productIndex = currentUserProducts.findIndex(
        (p) => p.id == productId
      );
      if (productIndex > -1) {
        ...
        const getFileUrlForUpdate = (id, existingUrl) => {
          ...
          return fileInput && fileInput.files[0]
            ? URL.createObjectURL(fileInput.files[0])
            : existingUrl;
        };

        const activeCategoryLink = document.querySelector(
          "#dashboard-page .category-list a.active"
        );
        const category = activeCategoryLink
          ? activeCategoryLink.dataset.category
  ...
  if (deleteBtn) {
    deleteBtn.addEventListener("click", () => {
      ...
      const currentUserEmail = getLoggedInUserEmail();
      let currentUserProducts = getUserProducts(currentUserEmail);
      currentUserProducts = currentUserProducts.filter(
        (p) => p.id != productId
      );
      saveUserProducts(currentUserEmail, currentUserProducts);
  ...
  renderStoreProducts("all");
  // ====================================================================
  // === FINAL SUBMIT FORM CODE FOR main.js =============================
  // ====================================================================
});
